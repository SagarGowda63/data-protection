...
<?php
    ...
    if (isset($_POST['LoginId'])) {
        ...
        $query    = "SELECT * FROM `distributorinfo` WHERE LoginId='$LoginId'
		...
		if ($rows == 1) {
            ...
            header("Location: distributorform.html");
        } else {
            echo "<div class='form'>
                  <h3>Incorrect Username/password.</h3><br/>
                  <p class='link'>Click here to <a href='distributorlogin.php'>Login</a> again.</p>
                  </div>";
        }
    } else {
?>
