...
<?php
    ...
    if (isset($_REQUEST['LoginId'])) {
        ...
        $query    = "INSERT into `userinfo` (LoginId, UserPassword, FName, LName, CellNumber,  EmailAddress, rollId, city, pincode, create_datetime)
                     VALUES ('$LoginId', '" . md5($UserPassword) . "', '$FName', '$LName', '$CellNumber',  '$EmailAddress', '$rollId', '$city', '$pincode', '$create_datetime')";
